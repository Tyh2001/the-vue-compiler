...
function tokenizer (input) {
  ...
  while (current < input.length) {
    ...
    //接下来，我们将检查空格。这很有趣
    //因为我们关心空格的存在是为了分隔字符，但是
    //对我们来说，作为代币存储并不重要。我们只会扔
    //以后再说吧。
    //
    //所以在这里，我们只是要测试它的存在，如果它确实存在，我们就是
    ...
    if (NUMBERS.test(char)) {
      ...
      //然后我们将循环遍历序列中的每个字符，直到
//我们遇到一个不是数字的角色，按下每个角色
//这是我们的“值”的一个数字，并随着“电流”的增加而增加。
...
// 所以我们有了transformer函数，它将接受 lisp ast.
...
/**
 * 编译器
 * 最后我们将创建“compiler”函数。在这里，我们将联系在一起
 * 管道的每一部分
 *
